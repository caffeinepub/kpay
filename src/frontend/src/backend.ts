...
export class Backend implements backendInterface {
    ...
    async confirmTransfer(arg0: ConfirmTransferRequest): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.confirmTransfer(to_candid_ConfirmTransferRequest_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createAdminProfile(arg0: string, arg1: string, arg2: string, arg3: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createAdminProfile(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createTransfer(arg0: CreateTransferRequest): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createTransfer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterTransactions(arg0: TransactionFilter): Promise<Array<Transaction>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterTransactions(to_candid_TransactionFilter_n14(this._uploadFile, this._downloadFile, arg0));
    ...
    async sendNotification(arg0: string, arg1: string, arg2: Principal | null): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.sendNotification(arg0, arg1, to_candid_opt_n32(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "bill" in value ? TransactionType.bill : "airtime" in value ? TransactionType.airtime : "transfer" in value ? TransactionType.transfer : value;
}
...
function to_candid_ConfirmTransferRequest_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ConfirmTransferRequest): _ConfirmTransferRequest {
    return to_candid_record_n11(_uploadFile, _downloadFile, value);
}
function to_candid_TransactionFilter_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TransactionFilter): _TransactionFilter {
...
function to_candid_TransactionType_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TransactionType): _TransactionType {
...
function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        status: to_candid_TransactionStatus_n12(_uploadFile, _downloadFile, value.status),
...
function to_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    userFilter: [] | [Principal];
    transactionTypeFilter: [] | [_TransactionType];
    statusFilter: [] | [_TransactionStatus];
} {
    return {
        userFilter: value.userFilter ? candid_some(value.userFilter) : candid_none(),
        transactionTypeFilter: value.transactionTypeFilter ? candid_some(to_candid_TransactionType_n16(_uploadFile, _downloadFile, value.transactionTypeFilter)) : candid_none(),
        statusFilter: value.statusFilter ? candid_some(to_candid_TransactionStatus_n12(_uploadFile, _downloadFile, value.statusFilter)) : candid_none()
    };
}
...
function to_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TransactionType): {
    bill: null;
} | {
    airtime: null;
} | {
    ...
    return value == TransactionType.bill ? {
        bill: null
    } : value == TransactionType.airtime ? {
        airtime: null
